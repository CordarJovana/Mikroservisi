...
function Calendar(props) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const responseExamDates = await axios.get(`http://35.222.157.204:1337/getAllExamsReg/${id}`);
        const responseExamRegistrations = await axios.get(`http://35.222.157.204:1337/getAllExamDeadlines`);
